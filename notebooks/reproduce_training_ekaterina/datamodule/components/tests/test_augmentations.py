...
def test_pad_spectrogram_width_equal_width(sample_spectrogram):
    """
...
def test_pad_spectrogram_width_increased_width_odd(sample_spectrogram):
    """
...
def test_pad_spectrogram_width_increased_width_even(sample_spectrogram):
    """
...
def test_pad_spectrogram_width_decreased_width_even(sample_spectrogram):
    """
...
def test_pad_spectrogram_width_decreased_width_odd(sample_spectrogram):
    """
...
def test_pad_spectrogram_width_value(sample_spectrogram):
    """
...
def test_randomtimestretch_probability(sample_spectrogram):
    """
...
def test_randomtimestretch_no_probability(sample_spectrogram):
    """
...
def test_randomtimestretch_pad_width(sample_spectrogram):
    """
...
def test_randomtimestretch_complex_to_float(sample_spectrogram):
    """

...
# modified original file from:
# https://github.com/DBD-research-group/BirdSet/blob/main/birdset/train.py
...
_HYDRA_PARAMS = {
    "version_base": None,
    "config_path": str(root / "notebooks/reproduce_training_ekaterina/config"),
...
def train(cfg):
    ...
    with open_dict(cfg):
        ...
        cfg.module.network.model[
            "num_classes"] = datamodule.num_classes  # TODO not the correct classes when masking in valid/test only
